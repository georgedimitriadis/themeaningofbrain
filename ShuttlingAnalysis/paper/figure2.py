...
def genfromtxt(folders):
    ...
    lesions = sessions.genfromsubjects(lesionfolders,range(5,6),shuttling)
    print "Processing controls..."
    controls = sessions.genfromsubjects(controlfolders,range(5,6),shuttling)
    return figure2(lesions, controls)