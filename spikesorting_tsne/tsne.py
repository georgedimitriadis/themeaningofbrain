...
def t_sne(samples, files_dir=None, exe_dir=None, num_dims=2, perplexity=100, theta=0.4, eta=200, exageration=12.0,
    ...
    closest_indices_in_hd, closest_distances_in_hd = \
        gpu.calculate_knn_distances(template_features_sparse_clean=data, perplexity=perplexity, mem_usage=0.9,
                                    verbose=True)
...
# The data_has_exageration needs to go once there are no old data sets with no exageration
