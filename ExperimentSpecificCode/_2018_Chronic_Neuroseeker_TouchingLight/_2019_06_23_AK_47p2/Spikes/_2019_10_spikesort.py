...
from ExperimentSpecificCode._2018_Chronic_Neuroseeker_TouchingLight._2019_06_23_AK_47p2 import constants as const
...
plt.hist(thal_cells['firing rate'], bins=np.logspace(np.log10(0.001), np.log10(100), 50))
...
global previous_template_numbera
