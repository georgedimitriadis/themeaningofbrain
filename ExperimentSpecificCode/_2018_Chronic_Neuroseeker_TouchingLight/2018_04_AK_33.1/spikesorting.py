...
kilosort_folder = join(r'F:\Neuroseeker\AK_33.1', date_folders[1], 'Analysis', 'Kilosort')

base_info_folder = r'E:\Software\Develop\Source\Repos\Python35Projects\TheMeaningOfBrain\Layouts\Probes\Neuroseeker'
prb_file = join(base_info_folder, 'ap_only_prb.txt')

binary_data_filename = join(r'F:\Neuroseeker\AK_33.1', date_folders[1], 'Data', 'Amplifier_APs.bin')
