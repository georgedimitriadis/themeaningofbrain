...
# D:\Neuroseeker chronic\AK_47.1\2019_07_04-11_51\Analysis\NNs
# or
# D:\Neuroseeker chronic\AK_47.1\2019_07_04-11_51\Analysis\NeuropixelSimulations\Sparce\NNs
# or
# D:\Neuroseeker chronic\AK_47.1\2019_07_04-11_51\Analysis\NeuropixelSimulations\Long\NNs
...
video_folder = join(base_data_folder, 'SubsampledVideo')
...
cap = cv2.VideoCapture(join(video_folder, 'Video_undistrorted_150x112_120fps.avi'))

full_matrix = np.memmap(join(data_folder, "full_matrix_with_extra_poisson_data.npy"),
                        dtype=np.int16, mode='r', shape=(num_of_frames, num_of_neurons_full))
...
fullmatrix = np.memmap(join(data_folder, "full_matrix.npy"),
                        dtype=np.int16, mode='r', shape=(num_of_neurons, num_of_frames)).T
