...
kilosort_folder = join(const.base_save_folder, const.rat_folder, const.date_folders[date_folder], 'Analysis', 'Denoised',
                       'Kilosort')
...
db, n_clusters_, labels, core_samples_mask, score = tsne_funcs.fit_dbscan(X, eps=0.022, min_samples=40,
...
good_clusters = [48, 60, 68, 77, 86, 89, 98, 101, 103,   56, 63, 76, 79, 83, 84]
final_clusters = [28, 48, 68, 83, 98]

plt.figure(1)
pf.show_clustered_tsne(db, tsne_result, juxta_cluster_indices_grouped=None, threshold_legend=None,
                        func_to_exec_on_pick=show_frame, args_of_func_on_pick=[], labels_on=good_clusters)
