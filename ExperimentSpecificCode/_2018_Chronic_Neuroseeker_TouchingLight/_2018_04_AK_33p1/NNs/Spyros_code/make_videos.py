...
spiky_model_file = join(data_folder, 'spikes_latest_model_half_size_spyros.h5')
picture_model_file = join(data_folder, 'pictures_latest_model_half_size_spyros.h5')

save_data_file = join(data_folder, 'data_random_5secs_half_size_res.npz')
...
write_to_video = join(data_folder, 'results_video_1hour_halfsize_5secsBrain.avi')
