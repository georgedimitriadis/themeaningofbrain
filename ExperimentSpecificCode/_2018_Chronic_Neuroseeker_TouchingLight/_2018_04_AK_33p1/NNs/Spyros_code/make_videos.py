...
spiky_model_file = join(data_folder, 'spiky_latest_model_half_size_spyros.h5')
picture_model_file = join(data_folder, 'pictures_latest_model_half_size_spyros.h5')

save_data_file = join(data_folder, 'data_random-full_half_size_res.npz')
...
write_to_video = join(data_folder, 'results_video_1hour_halfsize_5secsBrain_10secsPic.avi')
...
cap_results = cv2.VideoWriter(write_to_video, fourcc, 120.0, (results_video_resolution[1], results_video_resolution[0]))
