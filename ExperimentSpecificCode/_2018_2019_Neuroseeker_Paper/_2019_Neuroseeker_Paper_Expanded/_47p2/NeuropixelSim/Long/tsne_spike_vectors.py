...
results_folder = join(analysis_folder, 'NeuropixelSimulations', 'Long', 'Results')
...
plt.scatter(tsne_result[:, 0], tsne_result[:, 1], s=3, c='k')
...
tsne_pcs_count_image_extent = [-9, 8, -7.2, 8]
...
#Templates used: 15 (blue), 47 (lightgreen), 53 (yellow), 60 (red)
