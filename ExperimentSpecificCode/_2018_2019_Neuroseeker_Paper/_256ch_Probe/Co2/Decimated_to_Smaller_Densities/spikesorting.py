...
from ExperimentSpecificCode._2018_2019_Neuroseeker_Paper._256ch_Probe.Co2.Decimated_to_Smaller_Densities\
...
binary_data_filename = join(decimated_data_folder, r'decimated_data_256channels.bin')
...
binary_sparce_data_filename = join(decimated_sparce_data_folder, r'decimated_sparce_data_256channels.bin')
...
#                                                                                original
#                                                                                "D:\_256channels\Co2\Analysis\Decimated_to_NeuroSeeker_Density\Kilosort"
#                                                                                "D:\_256channels\Co2\Analysis\Decimated_to_NeuroSeeker_Density\decimated_data_256channels.bin"
#                                                                                256
#                                                                                50
...
# b) Clean:
clean.cleanup_kilosorted_data(kilosort_sparce_folder,
                              number_of_channels_in_binary_file=const.NUMBER_OF_AP_CHANNELS_IN_BINARY_FILE,
                              binary_data_filename=binary_sparce_data_filename, #binary_data_filename
...
# c) Remove some types
template_marking = np.load(join(kilosort_sparce_folder, 'template_marking.npy'))
